...
Hubot is a chat bot built on the [Hubot][hubot] framework. It was initially generated by [generator-hubot][generator-hubot].
...
Install [NodeJS](http://nodejs.org/download/) (NPM is also installed).
    ...
    % git clone git@bitbucket.org:socialsuperstore/hubot.git

...
get_end_point = (options) ->
  return {
    accounts: 'v1.2/accounts?page_index=0',
    apps: 'v1.2/accounts/'+options.account_id+'/apps'
    downloads: 'v1.2/accounts/'+options.account_id+'/apps/'+options.app_id+'/sales'+'?start_date='+options.start_date+'&end_date='+options.end_date+'&countries='+options.countries
  }
...
# Returns account information
  robot.respond /annie accounts/i, (msg) ->
    ...
    .get() (err, res, body) ->
      ...
      msg.send 'account_id: '+ data.accounts[0].account_id
      msg.send "```" + body + "```"
